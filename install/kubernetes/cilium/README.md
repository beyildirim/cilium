...
| egressGateway.NATMAPStatsEntries | int | `32` | Number of the top-k SNAT map connections to track in Cilium statedb. |
| egressGateway.NATMAPStatsInterval | string | `"30s"` | Interval between how often SNAT map is counted for stats. |
